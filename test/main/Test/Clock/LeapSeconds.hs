...
testParseNISTLeapSecondList =
    testCase "parseNISTLeapSecondList" $ let
...
testLeapSecondListToMap =
    testCase "leapSecondListToMap" $ let
        sampleLeapSecondList :: LeapSecondList
        sampleLeapSecondList =
            MkLeapSecondList
                { lslVersion = fromGregorian 1974 1 1
                , lslExpiration = fromGregorian 1975 1 1
                , lslTransitions = [(fromGregorian 1972 1 1, 10), (fromGregorian 1972 7 1, 11)]
                }
...
testLeapSeconds = testGroup "leapseconds" $ [testParseNISTLeapSecondList, testLeapSecondListToMap]
